...
| Flash / flicker at regular intervals | `memory-types` (boundary) | `wm_rollout_diff` + Vision `vision_pixel_diff` |
...
| Need to *see* the worst frame | (none here) | Vision Toolkit `vision_glance` |
